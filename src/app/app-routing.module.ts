...
const routes: Routes = [
  ...
  { path: 'admin/addmovie', component: AdminaddmovieComponent  ,canActivate: [AuthGuard]},
  { path: 'admin/adduser', component: AdminadduserComponent,canActivate: [AuthGuard]  },
  { path: 'admin/addpromotion', component: AdminaddpromotionComponent  ,canActivate: [AuthGuard]},
  { path: 'admin/home', component: AdminhomeComponent ,canActivate: [AuthGuard]},
  { path: 'admin/manage/movies', component: AdminmanagemoviesComponent ,canActivate: [AuthGuard] },
  { path: 'admin/deletemovies', component: AdmindeletemovieComponent  ,canActivate: [AuthGuard]},
  { path: 'admin/manage/users', component: AdminmanageusersComponent  ,canActivate: [AuthGuard]},
  { path: 'admin/manage/promotions', component: AdminmanagepromotionsComponent  ,canActivate: [AuthGuard]},
